define(["require", "exports", "./filterUpdate", "./Subject"], function (require, exports, filterUpdate_1, Subject_1) {
    "use strict";
    ...
    var ControllerUpdate = /** @class */ (function () {
        function ControllerUpdate(form) {
            ...
            this.defineControllerUpdate = function (controller, key) {
                var self = _this;
                controller._changeObservable = new Subject_1.Subject();
                var m = function () {
                    var _a;
        ...
        ControllerUpdate.prototype.checkControllerChange = function (controller) {
            var _a = filterUpdate_1.filterUpdate(this.form.originalValue[controller.id], controller.value), originValue = _a[0], currentValue = _a[1];
            var end = function () {
                var _a;
                if (controller._changed)
                    (_a = controller._changeObservable) === null || _a === void 0 ? void 0 : _a.next(controller);
                return controller._changed;
            };

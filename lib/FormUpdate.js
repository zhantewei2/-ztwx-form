define(["require", "exports", "tslib", "./validators", "./filterUpdate", "./ControllerUpdate"], function (require, exports, tslib_1, validators_1, filterUpdate_1, ControllerUpdate_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.FormUpdateVersion = void 0;
    var FormUpdateVersion = /** @class */ (function (_super) {
        tslib_1.__extends(FormUpdateVersion, _super);
        function FormUpdateVersion(controllers) {
            ...
            _this.controllerUpdate = new ControllerUpdate_1.ControllerUpdate(_this);
        ...
        FormUpdateVersion.prototype.getUpdatedValue = function () {
            ...
            Object.keys(this.originalValue).forEach(function (key) {
                ...
                (_a = filterUpdate_1.filterUpdate(originValue, currentValue), originValue = _a[0], currentValue = _a[1]);
    ...
    exports.FormUpdateVersion = FormUpdateVersion;
});
